...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        auto clearColor = studio.clear_color;
        glClearColor(
            studio.clear_color.x * studio.clear_color.w, 
            studio.clear_color.y * studio.clear_color.w, 
            studio.clear_color.z * studio.clear_color.w, 
            studio.clear_color.w);
