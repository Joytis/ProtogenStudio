...
struct float3
{
    ...
    VM_INLINE float x() const { return vgetq_lane_f32(m, 0); }
    VM_INLINE float y() const { return vgetq_lane_f32(m, 1); }
    VM_INLINE float z() const { return vgetq_lane_f32(m, 2); }
...
struct float3
{
    ...
    VM_INLINE float x() const { return x; }
    VM_INLINE float y() const { return y; }
    VM_INLINE float z() const { return z; }
    VM_INLINE void x(float x_) { x = x_; }
    VM_INLINE void y(float y_) { y = y_; }
    VM_INLINE void z(float z_) { z = z_; }
    VM_INLINE void store(float *p) const { p[0] = x(); p[1] = y(); p[2] = z(); }
